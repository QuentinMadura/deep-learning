“Deep Learning with PyTorch: Zero to GANs” is an online course intended to provide a coding- first introduction to deep learning using the PyTorch framework.
